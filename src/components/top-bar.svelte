...
<div
	class="sticky top-0 z-10 bg-white flex items-center justify-between gap-2 px-4 py-4 sm:px-6 print:hidden"
>
	<a href="/" aria-label="Back to home page">
		<h1 class="text-left">SPEAKTOSTEVE</h1>
	</a>
	<div class="flex items-center gap-3 text-black sm:scale-100">
		<ModeSwitch />
